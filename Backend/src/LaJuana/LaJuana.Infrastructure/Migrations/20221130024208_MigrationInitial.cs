        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PronounPreference = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RelationshipTypeRequiredID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    FemaleDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    MaleDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NeutralDescription = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
            ...
            migrationBuilder.CreateIndex(
                ...
                unique: true,
                filter: "[RelationshipTypeRequiredID] IS NOT NULL");
